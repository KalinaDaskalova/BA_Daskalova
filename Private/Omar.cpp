...
// Called every frame
void AOmar::Tick(float DeltaTime)
{
...
void AOmar::SetActorTicks(bool set)
{
	this->SetActorTickEnabled(set);
}

void AOmar::MoveToLocation(FVector Location, float Speed, float AccepptanceRadius)
{
...
void AOmar::SetOmarDialogues()
{
	FDialogueUtterance MP_1;
	MP_1.Audiofile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP1.wav");
	MP_1.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP1.csv");
	OmarDialogues.MP1 = MP_1;

	FDialogueUtterance MP_2;
	MP_2.Audiofile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP2.wav");
	MP_2.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP2.csv");
	OmarDialogues.MP2 = MP_2;

	FDialogueUtterance MP_3;
	MP_3.Audiofile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP3.wav");
	MP_3.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP3.csv");
	OmarDialogues.MP3 = MP_3;

	FDialogueUtterance MP_4;
	MP_4.Audiofile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP4.wav");
	MP_4.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP4.csv");
	OmarDialogues.MP4 = MP_4;

	FDialogueUtterance MP_5;
	MP_5.Audiofile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP5.wav");
	MP_5.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/MeetingPoint/Omar_MP5.csv");
	OmarDialogues.MP5 = MP_5;

	FDialogueUtterance After_You;
	After_You.Audiofile = FString("/GroupNavigation/Dialogues/Participants/Omar/Omar_AfterYou.wav");
	After_You.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/AfterYou.csv");
	OmarDialogues.AfterYou = After_You;

	FDialogueUtterance Go_Ahead;
	Go_Ahead.Audiofile = FString("/GroupNavigation/Dialogues/Participants/Omar/Omar_GoAhead.wav");
	Go_Ahead.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/GoAhead.csv");
	OmarDialogues.GoAhead = Go_Ahead;

	FDialogueUtterance Over_Here;
	Over_Here.Audiofile = FString("/GroupNavigation/Dialogues/Participants/Omar/Omar_HeyOverHere.wav");
	Over_Here.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/OverHere.csv");
	OmarDialogues.OverHere = Over_Here;

	FDialogueUtterance Okay_Lets_Go;
	Okay_Lets_Go.Audiofile = FString("/GroupNavigation/Dialogues/Participants/Omar/Omar_OkayLetsGo.wav");
	Okay_Lets_Go.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/OkayLetsGo.csv");
	OmarDialogues.OkayLetsGo = Okay_Lets_Go;
/*
	FDialogueUtterance No_Fog;
	No_Fog.Audiofile = FString("/GroupNavigation/Dialogues/Participants/Omar/Omar_NoFog.wav");
	No_Fog.FaceAnimFile = FString("/GroupNavigation/Dialogues/Participants/NoFog.csv");
	OmarDialogues.NoFog = No_Fog;
*/

}


void AOmar::PreLoadFaceAnimationFiles()
{
	FaceAnimComp->LoadAnimationFile(OmarDialogues.MP1.FaceAnimFile);
	FaceAnimComp->LoadAnimationFile(OmarDialogues.MP2.FaceAnimFile);
	FaceAnimComp->LoadAnimationFile(OmarDialogues.MP3.FaceAnimFile);
	FaceAnimComp->LoadAnimationFile(OmarDialogues.MP4.FaceAnimFile);
	FaceAnimComp->LoadAnimationFile(OmarDialogues.MP5.FaceAnimFile);
	FaceAnimComp->LoadAnimationFile(OmarDialogues.AfterYou.FaceAnimFile);
	FaceAnimComp->LoadAnimationFile(OmarDialogues.GoAhead.FaceAnimFile);
	FaceAnimComp->LoadAnimationFile(OmarDialogues.OverHere.FaceAnimFile);
...
void AOmar::GazeModel(float DeltaTime)
{
...
void AOmar::GazeModelPoI(float DeltaTime)
{
	GazeTimeElapsed += DeltaTime;
	UserInSightTimeElapsed += DeltaTime;
	const float PeripheralVisionAngle = 120.0f;
...
void AOmar::TurnTo(FVector Location, float StartThreshold, float EndThreshold, float DeltaTime)
{
...
void AOmar::CheckDistanceToPoint()
{
